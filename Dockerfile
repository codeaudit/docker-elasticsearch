...
RUN wget --progress=dot:mega -O - http://download.elasticsearch.org/elasticsearch/elasticsearch/elasticsearch-1.0.3.tar.gz | tar -zx -C /elasticsearch --strip-components=1
